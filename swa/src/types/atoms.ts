...
/**
 * 正解・解説文・回答のポイントを管理するatomの型
 * 初期値の場合はundefined
 */
export type AnswerExplanation =
  | {
      /**
       * 正解・解説文・回答のポイントが生成中の場合はtrue、
       * 正解・解説文・回答のポイントが生成済みの場合はfalse
       */
      isSubmitting: boolean;

      /**
       * 正解・解説文・回答のポイントが生成済みかつ正解の場合はtrue、
       * 正解・解説文・回答のポイントが生成済みかつ不正解の場合はfalse
       * 正解・解説文・回答のポイントが生成中の場合はundefined
       */
      correctFlags?: boolean[];

      /**
       * 正解・解説文・回答のポイントが生成済みの場合は各選択肢の正解/不正解の理由、
       * 正解・解説文・回答のポイントが生成中の場合はundefined
       */
      explanations?: string[];
       ...
       * 正解・解説文・回答のポイントが生成済みの場合は値が設定される、
       * 正解・解説文・回答のポイントが生成中の場合はundefined
       */
      ...
      /**
       * 正解・解説文・回答のポイントが生成済みの場合は正解の選択肢のインデックス、
       * 正解・解説文・回答のポイントが生成中の場合はundefined
       */
      correctIdxes?: number[];

      /**
       * 正解・解説文・回答のポイントが生成済みかつ回答履歴が保存済みの場合はtrue、
       * 正解・解説文・回答のポイントが生成済みかつ回答履歴が未保存の場合はfalse、
       * 正解・解説文・回答のポイントが生成中の場合はundefined
       */
